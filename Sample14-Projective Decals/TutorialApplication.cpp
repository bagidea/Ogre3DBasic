...
bool TutorialApplication::frameRenderingQueued(const Ogre::FrameEvent& fe)
{
  ...
  //CEGUI::Window* tutorialLabel = CEGUI::System::getSingleton().getDefaultGUIContext().getRootWindow()->getChild("SampleLabel");
...
void TutorialApplication::addDecalToMaterial(const Ogre::String& matName)
{
